  ...
  return (
    <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-5 shadow-sm transition-colors duration-200">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-2xl font-bold text-on-surface dark:text-slate-100">Bus #3</h3>
      ...
      <div className="flex gap-2 mb-5">
        <button
          ...
          className={`flex-1 py-2 px-3 rounded-lg text-sm font-semibold transition-all duration-150 active:scale-95 ${
            direction === "station"
          ...
          return (
            <div key={stop.id}>
              <div className="relative flex gap-4 mb-1">
                {/* Stop circle */}
                <div
                  className={`relative z-10 w-10 h-10 rounded-full border-2 flex items-center justify-center shrink-0 mt-1 shadow-sm transition-colors duration-200 ${
                    isFirst || isLast
